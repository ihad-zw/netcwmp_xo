...
typedef int   	(*parameter_get_handler_pt)(cwmp_t * cwmp, parameter_node_t * node,const char * param_name, char ** value, pool_t * pool);

typedef int     (*parameter_set_handler_pt)(cwmp_t * cwmp, parameter_node_t * node,const char * param_name, const char * value, int length, callback_register_func_t callback_reg);
...
typedef int     (*parameter_setp_handler_pt)(cwmp_t * cwmp, parameter_node_t * param_node, callback_register_func_t callback_reg ); 
