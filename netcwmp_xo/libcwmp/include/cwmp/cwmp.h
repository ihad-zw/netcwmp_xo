...
#define InternetGatewayDeviceModule         "Device"
...
#define AddressingTypeModuel		"AddressingType"
#define IPAddressModuel 		"IPAddress"
#define MACAddressModuel		"MACAddress"
#define SubnetMaskModuel		"SubnetMask"
#define DefaultGatewayModuel		"DefaultGateway"
#define DNSServersModuel		"DNSServers"


#define X_CTC_IPTVModule 		"X_CTC_IPTV"
#define STBIDModule			"STBID"
...
struct cwmp_st
{
    ...
    SSL_CTX * ssl_ctx;
#endif
	struct paratab	*pParaNodeTab;
	struct paratab	*pGetParaTab;
	struct paratab	*pSetParaTab;
...
struct parameter_node_st
{
	...
	parameter_setp_handler_pt setp;
