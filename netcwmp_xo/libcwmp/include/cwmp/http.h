...
#define HTTPD_CWMP	"/cwmp"

#define CONTENT_TYPE_URLENCODED	"application/x-www-form-urlencoded"
#define CONTENT_TYPE_JSON	"application/json"
#define CONTENT_TYPE_OCTSTREAM	"application/octet-stream"
...
typedef struct _http_parser_t        http_parser_t;
typedef struct _http_dest_t          http_dest_t;
typedef struct _http_request_t       http_request_t;
typedef struct _http_response_t      http_response_t;
typedef struct _http_socket_t        http_socket_t;
typedef struct _http_sockaddr_t      http_sockaddr_t;
typedef struct _http_digest_auth_t   http_digest_auth_t;
